...
class UserProfileListadapter(
    val items: ArrayList<Myfavorites>?,
    val context: Context,
    val parent: View,
    val frag: ProfileDetails
) : RecyclerView.Adapter<UserProfileListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserProfileListViewHolder {
        ...
        return UserProfileListViewHolder(
...
//                    holder.channel_txt_program_item_name.text = programListData.ContentType
                    ...
                    if (programListData.CreatedBy != null) {
...
//                CommonMethods.SnackBar( holder.parent, context.getString(R.string.error), false)
    ...
    private fun SetFavourite(input: SetFavReqClass, programListData: Myfavorites) {
...
class UserProfileListViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    val channel_ivImageView = view.program_item_imageView
    val parent = view.layout_content_all
    //    val item_favourite = view.profile_item_favourite
