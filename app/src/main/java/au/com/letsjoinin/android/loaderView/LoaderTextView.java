package au.com.letsjoinin.android.loaderView;
...
public class LoaderTextView extends AppCompatTextView implements LoaderView {
    ...
    public   int ANIMATION_CYCLE_DURATION = 150; //milis
    ...
    private void init(AttributeSet attrs) {
        ...
        loaderController.ANIMATION_CYCLE_DURATION = ANIMATION_CYCLE_DURATION;
